...
export const NAV: NavItem[] = [
  { id: "dashboard", group: "Operasional", label: "Ringkasan", icon: "dashboard", href: "/dashboard", status: "wip" },
  { id: "calendar", group: "Operasional", label: "Kalender", icon: "calendar", href: "/calendar", status: "wip" },
  { id: "bookings", group: "Operasional", label: "Booking", icon: "booking", href: "/bookings", status: "done" },
  { id: "piutang", group: "Keuangan", label: "Kas Piutang", icon: "receivable", href: "/piutang", status: "wip" },
  ...
  { id: "master", group: "Sistem", label: "Master Data", icon: "master", href: "/master/services", status: "done" },
